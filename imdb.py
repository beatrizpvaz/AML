...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr  9 22:43:05 2019
...
import os
import argparse
from imdb_feedforward import *
from imdb_rnn import *
import tensorflow as tf

def network_one(learning_rate, epochs, batches,seed):

    print("RELU network with 4 hidden layers and l1 regularization")
    print("Combination One with learning rate: {} epochs: {} and batch size: {}".format(learning_rate, epochs, batches))
    mlp_network(1.1, learning_rate, epochs, batches,seed, activation_func=tf.nn.relu)


def network_two(learning_rate, epochs, batches,seed):

    print("Recurrent Neural Network with 2 LSTM layers")
    print("Combination Two with learning rate: {} epochs: {} and batch size: {}".format(learning_rate, epochs, batches))
    train_rnn(1, learning_rate, epochs, batches, seed, activation_func=tf.nn.sigmoid)
